...
const AvatarDropdown = ({ user }) => {
  ...
  const { loading, setLoading } = useLoading(); // using global loading state
  ...
  return (
    <>
      ...
      {/* ✅ Smooth animated global spinner */}
      <AnimatePresence>
        {loading && (
          <motion.div
            key="logout-spinner"
          ...
          >
            <div className="bg-white dark:bg-zinc-900 p-6 rounded-lg shadow-lg flex flex-col items-center">
              ...
              <span className="text-blue-700 dark:text-white font-semibold mt-2">Logging out...</span>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
